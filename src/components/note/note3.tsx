...
export const Note3 = ({ note, handleOpenModal }: myProps) => {
  return (
    <div className="note my-2 bg-[#F6ECC9] h-[120px] w-[250px] md:h-[150px] md:w-[300px] rounded-br-3xl rounded-tl-3xl border-2 border-[#cac7bd]">
