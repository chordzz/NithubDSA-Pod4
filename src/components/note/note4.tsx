...
export const Note4 = ({ note, handleOpenModal }: myProps) => {
  return (
    <div className="note my-2 bg-[#98B7DB] h-[120px] w-[250px] md:h-[150px] md:w-[300px] rounded-tr-3xl rounded-bl-3xl border-2 border-[#62758b]">
